    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">NHITM</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">NHITM</span> <span class="clr-green md">Canteen</span></div>
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://nhitm.co.in/" target="_blank">NHITM</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-9529703059</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>admission@nhitm.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Kavesar,Thane</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.nhitm.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                ...
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-envelope"></i> <p>admission@nhitm.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>NHITM, Kavesar, Thane</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.nhitm.ac.in</p></li>
                        </ul>
                    </article>
                </main>
